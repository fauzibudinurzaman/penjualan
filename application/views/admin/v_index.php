...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="<?php echo base_url().'administrator/cekuser'?>">Tridjaya Motor Pagaden</a>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright© 2023 <a href="#" target="_blank">Fitria Nur Fatimah</a></span>
            </div>
          </div>
        </footer>
    <!-- /#wrapper -->
